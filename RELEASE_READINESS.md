...
Behavior-affecting source fingerprint: `e4e8eebfb09a7304c53f4eccb8d9b223823ad3bc5d61753371fafcc6f97d98c5`. The source map is included in [the public release summary](docs/example/evidence/release_summary.json). Each run records actual settings, manifest, runtime and artifact seals. Historical acceptance files are unnecessary for the current audit.
